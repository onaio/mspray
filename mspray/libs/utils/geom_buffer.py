...
def buffer_from_meters(geom, buffer_meters):
    ...
    # (e.g. circles become more and more egg-like further away from the
    # equator)
    #
    ...
    # (1) use the centroid of the input geometry to determine a single
    #     reference point
    # (2) transform this reference point into the appropriate UTM coordinate
    #     system. This is done using the correct UTM zone for the reference put
    ...
    # (4) transform the shifted point back from UTM to the input coordinate
    #     system and calculate the distance between the shifted point and the
    #     original point in the input coordinate system.
